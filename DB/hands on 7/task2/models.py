from sqlalchemy import Boolean, create_engine, Column, Integer, String, ForeignKey, Date, Numeric, TIMESTAMP
...
# Add this line inside your Student class
...
from sqlalchemy import ForeignKey, Time, String, Integer, Column
